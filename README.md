...
## Screenshots
<div align='center'>
  <img src="./docs/assets/cibeelization.gif" /><br><br>
  <label><strong> Imagem 1:</strong> Execução do Projeto <br> <strong>Fonte:</strong> <a href="https://github.com/raqueleucaria">Raquel Eucaria</a>, 2025.</label><br><br><br>
</div>
...
| Heitor Marques                |(1) Correção do bug de rastreamento residual mesmo com `.gitignore`, solucionando problemas no repositório.<br>(2) Implementação inicial do agente **IntruderBear**, criando a mecânica de intrusos que interagem com a colmeia.<br>(3) Desenvolvimento da lógica para geração periódica de intrusos, controlando o limite e a detecção pela Rainha.<br>(4) Expansão da interação do IntruderBear: roubo de mel, chance de atacar abelhas e possibilidade de ser repelido.<br>(5) Correção de bugs relacionados a mortes duplicadas causadas pelos intrusos.| Excelente | (1) [Correção de bug no rastreamento do repositório](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/3098e7be10653ce923d6774307cc64a8b3dc669a)<br>(2) [Implementação inicial do IntruderBear](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/f980abdbc3e1e57396b7a76826b7e700fa537239)<br>(3) [Lógica para geração periódica de intrusos](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/72e78736d9d6d688b67765b6ff5376059d229f1b)<br>(4) [Expansão das interações do IntruderBear](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/3ef2f8418d7ab9666587e9a2db40a129f1d97038)<br>(5) [Correção de mortes duplicadas causadas por intrusos](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/22c4477431f35337289f4b5f8f421c2dea593345)|
...
| José Luís Ramos Teixeira   | (1) Correção do bug de rastreamento residual mesmo com `.gitignore`, solucionando problemas no repositório.<br>(2) Implementação inicial do agente **IntruderBear**, criando a mecânica de intrusos que interagem com a colmeia.<br>(3) Desenvolvimento da lógica para geração periódica de intrusos, controlando o limite e a detecção pela Rainha.<br>(4) Expansão da interação do IntruderBear: roubo de mel, chance de atacar abelhas e possibilidade de ser repelido.<br>(5) Correção de bugs relacionados a mortes duplicadas causadas pelos intrusos.<br>(6) Implemento na documentação das interações entre os agentes na colmeia, facilitando o entendimento do funcionamento do projeto. | Excelente                                                                      | (1) [Correção de bug no rastreamento do repositório](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/3098e7be10653ce923d6774307cc64a8b3dc669a)<br>(2) [Implementação inicial do IntruderBear](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/f980abdbc3e1e57396b7a76826b7e700fa537239)<br>(3) [Lógica para geração periódica de intrusos](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/72e78736d9d6d688b67765b6ff5376059d229f1b)<br>(4) [Expansão das interações do IntruderBear](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/3ef2f8418d7ab9666587e9a2db40a129f1d97038)<br>(5) [Correção de mortes duplicadas causadas por intrusos](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/22c4477431f35337289f4b5f8f421c2dea593345)<br>(6) [Documentação das interações na colmeia](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/4e299ead93b04f133d39bb5db092628e5da892d1) |                                       |
| Leonardo Gonçalves Machado    |         (1) Sugestão do tema esolhido para desenvolver o projeto.<br>(2) Implementação de funcionalidades da Rainha.<br>(3) Criação do voo nupicial.<br>(4) Criação da rinha de rainhas.<br>(5) Morte e sucessão das rainhas.<br>(6) Implementação do ciclo de alimentação e morte por fome da operária e limpadora.<br>(7) Criação da abelha Inspetora.<br>(8) Ajustes das constantes.<br>(9) Correção de bugs.<br>                                     |                                     Excelente        |           [Lista de Commits](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commits/updates/?author=leonardogonmac)                             |
...
| Raquel T. Eucaria Pereira da Costa | (1) Documentação, elicitação dos requisitos do projeto. <br>(2). Tutoriais de instalação para auxílio do grupo () Configuração inicial para produção do projeto. <br>(3)  Implementação da condição de parada da produção de mel <br>(4) Interface inicial  <br>(5) Ajustes e Correções  |   Excelente |[(1)](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/issues/2) <br> [(2)](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/462a44f99be61de3ce9c090295032a454780521d)<br> [(3,4 e 5)](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commits/GUI?author=raqueleucaria)
| Zenilda Pedrosa Vieira        | (1) Implementação da condição de parada da produção de mel e <br>  Criação de uma interface para acompanhar o funcionamento da colmeia <br> (2) Documento inicial de descrição do projeto  <br> (3) Documento final de descrição do projeto | Excelente |            [Commit (1)](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/c41e2336d14a993adb8837f651321db0e4c035d8) <br> [Commit (2)](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/4a38555643c03e1308b973a10a6eb0bed6404abf) <br> [Commit (3)](https://github.com/UnBParadigmas2024-2/2024.2_G2_SMA_Cibeelization/commit/74f0a05771bba1766e0fcc3b8c9bd34ccb29af86)                                                                        |
