...
| Raquel T. Eucaria Pereira da Costa | (1) Elicitação dos requisitos do projeto. <br>(2). Tutoriais de instalação para auxílio do grupo () Configuração inicial para produção do projeto. <br>(3)  Implementação da condição de parada da produção de mel <br>(4) Interface inicial  <br>(5) Ajustes e Correções  |   Excelente  |                                        |
