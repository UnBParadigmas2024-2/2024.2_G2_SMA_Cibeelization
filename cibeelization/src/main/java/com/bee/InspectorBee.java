...
public class InspectorBee extends Agent {
    ...
    public static int tlProduction = 0; // TOTAL PRODUÇÃO DE MEL
    ...
    public static int taxHoney = 0;
    public static int eatHoney = 0;
    ...
    protected void setup() {
        ...
        // Regra nova: Delet os agentes cadastrados AMS
    ...
    public void imposto() {
        InspectorBee.taxHoney = (WorkerBee.quantityOfHoney *= 0.7);
    ...
    public static void printa_recursos() {
        tlBee = InspectorBee.queenBeeNumber + QueenBee.WorkerBeeNumber + QueenBee.janitorBeenumber + QueenBee.droneBeenumber;
        tlProduction = WorkerBee.quantityOfHoney;
        System.out.println("\n========== CICLO " + ciclos++ + " ==========");
        ...
        System.out.println("Imposto: -" + InspectorBee.taxHoney);
        // System.out.println("Roubo: -" );
        System.out.println("Alimentacao: -"+InspectorBee.eatHoney);
        System.out.println("------------------------------");
